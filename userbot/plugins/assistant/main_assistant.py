...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your ZaidBot 🐍", data="deploy")],
                [Button.url("Help Me ❓", "https://t.me/Zaid_Support")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("chat📺", "https://t.me/Zaid_team1")],
                [Button.url("Need Help ❓", "https://t.me/Zaid_support")],
            ],
        )
